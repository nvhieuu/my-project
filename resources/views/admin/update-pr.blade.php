...
<div class="w-full h-screen overflow-auto">
    ...
    <div class="w-8/12 mx-auto my-3" id="myError1">
        ...
        <form action="{{ route('Update-pr') }}" method="post"
            class="px-3 flex flex-col justify-center items-center w-full gap-3" id="form1">
            <p class="w-full text-xl font-bold text-red-600">SỬA SẢN PHẨM</p>
            {{ csrf_field() }}
            <div class="w-full">
                <p class="font-semibold m-auto text-base">Tên sản phẩm</p>
                <input type="text" value="{{ $pro->TenSanPham }}" class="px-4 py-2 w-full rounded border 
            ...
            <div class="w-full">
                ...
                <input type="text" value="{{ $pro->KhuyenMai }}" class="px-4 py-2 w-full rounded border border-gray-300 shadow-sm text-base placeholder-gray-500
            ...
            <div class="w-full">
                ...
                <input type="text" value="{{ $pro->DonGia }}" class="px-4 py-2 w-full rounded border border-gray-300 shadow-sm text-base placeholder-gray-500
                    placeholder-opacity-50 focus:outline-none focus:border-blue-500" name="DonGia">
            </div>
            <div class="w-full">
                <p class="font-semibold m-auto text-base">Tình trạng</p>
                <input type="text" value="{{ $pro->TinhTrang }}" class="px-4 py-2 w-full rounded border border-gray-300 shadow-sm text-base placeholder-gray-500
                    placeholder-opacity-50 focus:outline-none focus:border-blue-500" name="TinhTrang">
            </div>
            <div class="w-full">
                ...
                <textarea class="px-4 py-2 w-full rounded border border-gray-300 shadow-sm text-base placeholder-gray-500
                    placeholder-opacity-50 focus:outline-none focus:border-blue-500"
                    name="MoTa">{{ $pro->MoTa }}</textarea>
            </div>
            ...
            <div class="w-full">
                ...
                <textarea type="text" value="" class="px-4 py-2 w-full rounded border border-gray-300 shadow-sm text-base placeholder-gray-500
                    placeholder-opacity-50 focus:outline-none focus:border-blue-500"
                    name="ChiTiet">{{ $pro->ChiTiet }}</textarea>
            </div>
            <input type="hidden" value="{{$pro->IDSanPham}}" name="id">
